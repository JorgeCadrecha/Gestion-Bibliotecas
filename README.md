...
## Mi repositorio es: 
https://github.com/JorgeCadrecha/Gestion-Bibliotecas.git
...
```
java -Dspring.profiles.active=production -jar ./target/Gestion-Bibliotecas-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.bootify/gestion-bibliotecas
```
